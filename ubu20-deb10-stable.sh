...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e " Dev > tzystore ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e " Auther : ${green} tzystore ${NC}"
echo -e " © Recode By My Self tzystore ${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/Tzystore/autoscript/GM/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/Tzystore/autoscript/GM/Register"
# USERNAME
rm -f /usr/bin/user
...
function pasang_ssl() {
clear
print_install "Memasang SSL DOMAIN"
